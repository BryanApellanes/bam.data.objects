...
public class ObjectDataStorageEventArgs : EventArgs
{
    ...
    /// </summary>
    public IPropertyWriteResult PropertyWriteResult { get; set; } = null!;
    ...
    /// </summary>
    public IPropertyDescriptor PropertyDescriptor { get; set; } = null!;

    /// <summary>
    /// Gets or sets the storage slot being read from, if applicable.
    /// </summary>
    public IStorageSlot ReadingFrom { get; set; } = null!;
}